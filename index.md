...
To install `bvarnet` from CRAN, you need to have
[CmdStanR](https://mc-stan.org/cmdstanr/index.html) installed which is
not available on CRAN. To do this, make sure you have
[RTools](https://cran.r-project.org/bin/windows/Rtools/) (Windows) or
[Xcode](https://developer.apple.com/xcode/) (Mac) installed and the run
the following code
...
If you run into any problems, you can look at the [Getting started with
CmdStanR](https://mc-stan.org/cmdstanr/articles/cmdstanr.html) guide.

After setting up cmdstanr you can install the newest version of the
package from CRAN:
...
Or you can install the development version of `bvarnet` from
